...
module_dir = os.path.join(__location__, "../src/mbf_genomes")
try:
...
try:
    from mbf_genomes import __version__ as version
except ImportError:
    pass
else:
    release = version
...
htmlhelp_basename = 'mbf_genomes-doc'
...
latex_documents = [
  ('index', 'user_guide.tex', u'mbf_genomes Documentation',
...
def setup(app):
    ...
    github_doc_root = "https://github.com/TyberiusPrime/mbf_genomes"
